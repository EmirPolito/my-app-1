        ...
        <div className="min-h-screen bg-background text-foreground"> {/* min-h-screen: altura mínima pantalla completa, bg-background: fondo, text-foreground: color principal de texto */}
            ...
            <main className="py-16"> {/* py-16: padding vertical grande */}
                <div className="container"> {/* container: ancho máximo y centrado */}
                    {/* Hero Section */}
                    <div className="text-center mb-12"> {/* text-center: centra texto, mb-12: margen inferior */}
                        <h1 className="text-4xl font-extrabold tracking-tight text-foreground md:text-5xl mb-4"> {/* text-4xl: tamaño grande, font-extrabold: muy negrita, tracking-tight: poco espacio entre letras, md:text-5xl: más grande en md, mb-4: margen inferior */}
                            Precios
                        </h1>
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8"> {/* text-lg: texto grande, text-muted-foreground: color atenuado, max-w-2xl: ancho máximo, mx-auto: centrado horizontal, mb-8: margen inferior */}
                            Planes flexibles que se adaptan a tus necesidades. Sin costos ocultos.
                        </p>

                        {/* Toggle */}
                        <div className="inline-flex items-center gap-4 p-1 rounded-full bg-muted"> {/* inline-flex: flex en línea, gap-4: espacio entre hijos, p-1: padding, rounded-full: bordes redondeados, bg-muted: fondo atenuado */}
                            <button
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto"> {/* grid: cuadrícula, grid-cols-1: 1 columna, md:grid-cols-2: 2 en md, lg:grid-cols-4: 4 en lg, gap-6: espacio entre tarjetas, max-w-7xl: ancho máximo, mx-auto: centrado */}
                        {plans.map((plan, index) => (
                            ...
                            >
                                ...
                                <div className="text-center mb-6"> {/* text-center, mb-6 */}
                                ...
                                <ul className="space-y-3 mb-6 flex-1"> {/* space-y-3: espacio entre items, mb-6: margen inferior, flex-1: ocupa espacio vertical disponible */}
                    ...
                    {/* FAQ Teaser */}
                    <div className="mt-20 text-center"> {/* mt-20: margen superior grande, text-center: centra texto */}
                        <p className="text-muted-foreground"> {/* color atenuado */}
                            ¿Tienes preguntas?{" "}
                            <a href="/acerca" className="text-primary hover:underline"> {/* texto color primario, subrayado al hover */}
                                Contáctanos
                            </a>
                        </p>
                    </div>
